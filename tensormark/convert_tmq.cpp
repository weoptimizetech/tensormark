...
//
//   ./build/convert_tmq <model.safetensors> <out.tmq> q80|q40 [asis|transpose]
//   the layout argument defaults to `transpose` — pass `asis` for Llama / HF
//   nn.Linear weights, which are already (out, in).
#include "quant.h"
